          ...
          >
            ...
            >
              ...
              >
                <IoClose
                  size={24}
                  className="text-black dark:text-white min-[2000px]:w-[1.5vw] min-[2000px]:h-[1.5vw]"
                />
              </button>

              <div className="text-center pt-4">
                <span className="text-6xl min-[2000px]:text-[4vw] mb-6 min-[2000px]:mb-[3vh] block">
                  🖥️
                </span>
                ...
                <p className="text-zinc-600 dark:text-zinc-400 mb-8 min-[2000px]:mb-[4vh] leading-relaxed text-sm min-[2000px]:text-[1vw] min-[2000px]:leading-[1.8]">
                  I truly appreciate your support! The best way to connect with
                  me is by exploring my projects and reaching out on LinkedIn.
                ...
                <div className="flex justify-center">
                  <Magnetic strength={0.3}>
                    <motion.a
                      href="https://www.linkedin.com/in/ritesh-patraabc777"
                      target="_blank"
